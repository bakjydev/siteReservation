...
var internal$2 = require('@fullcalendar/timeline/internal');
var internal$1 = require('@fullcalendar/resource/internal');
var resourcePlugin = require('@fullcalendar/resource');
var internal$3 = require('@fullcalendar/scrollgrid/internal');
...
class SpreadsheetIndividualCell extends internal.BaseComponent {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        return (preact.createElement(internal.ContentContainer, { elTag: "td", elClasses: [
                'fc-datagrid-cell',
                'fc-resource',
            ], elAttrs: {
                role: 'gridcell',
...
class SpreadsheetGroupCell extends internal.BaseComponent {
    render() {
        let { props, context } = this;
        let { colSpec } = props;
        let renderProps = {
...
class SpreadsheetRow extends internal.BaseComponent {
    render() {
        let { props } = this;
        let { resource, rowSpans, depth } = props;
        let resourceFields = internal$1.buildResourceFields(resource); // slightly inefficient. already done up the call stack
        return (preact.createElement("tr", { role: "row" }, props.colSpecs.map((colSpec, i) => {
            ...
            let fieldValue = colSpec.field ? resourceFields[colSpec.field] :
                (resource.title || internal$1.getPublicId(resource.id));
            if (rowSpan > 1) {
...
SpreadsheetRow.addPropsEquality({
    rowSpans: internal.isArraysEqual,
});

// for HORIZONTAL cell grouping, in spreadsheet area
class SpreadsheetGroupRow extends internal.BaseComponent {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        return (preact.createElement("tr", { role: "row" },
            preact.createElement(internal.ContentContainer, { elTag: "th", elClasses: [
                    'fc-datagrid-cell',
                    'fc-resource-group',
...
SpreadsheetGroupRow.addPropsEquality({
    group: internal$1.isGroupsEqual,
});
...
class SpreadsheetHeader extends internal.BaseComponent {
    constructor() {
        super(...arguments);
        this.resizerElRefs = new internal.RefMap(this._handleColResizerEl.bind(this));
        this.colDraggings = {};
    }
    render() {
        ...
        rowNodes.push(preact.createElement("tr", { key: "row", role: "row" }, colSpecs.map((colSpec, i) => {
            ...
            return (preact.createElement(internal.ContentContainer, { key: i, elTag: "th", elClasses: ['fc-datagrid-cell'], elAttrs: { role: 'columnheader' }, renderProps: renderProps, generatorName: "resourceAreaHeaderContent", generator: colSpec.headerContent, classNameGenerator: colSpec.headerClassNames, didMount: colSpec.headerDidMount, willUnmount: colSpec.headerWillUnmount }, (InnerContent) => (preact.createElement("div", { className: "fc-datagrid-cell-frame", style: { height: rowInnerHeight } },
                preact.createElement("div", { className: "fc-datagrid-cell-cushion fc-scrollgrid-sync-inner" },
    ...
    initColResizing(resizerEl, index) {
        ...
        if (ElementDraggingImpl) {
            ...
            dragging.emitter.on('dragstart', () => {
                let allCells = internal.findElements(internal.elementClosest(resizerEl, 'tr'), 'th');
...
class ResourceTimelineLane extends internal.BaseComponent {
    constructor() {
        super(...arguments);
        this.refineRenderProps = internal.memoizeObjArg(internal$1.refineRenderProps);
        this.handleHeightChange = (innerEl, isStable) => {
            if (this.props.onHeightChange) {
                ...
                internal.elementClosest(innerEl, 'tr'), isStable);
            }
        };
    }
    render() {
...
*/
class DividerRow extends internal.BaseComponent {
    render() {
        let { props, context } = this;
        ...
        return (preact.createElement("tr", { ref: props.elRef },
            preact.createElement(internal.ContentContainer, { elTag: "td", elRef: props.elRef, elClasses: [
                    'fc-timeline-lane',
                    'fc-resource-group',
                    context.theme.getClass('tableCellShaded'),
...
class ResourceTimelineLanesBody extends internal.BaseComponent {
    render() {
        let { props, context } = this;
...
class ResourceTimelineLanes extends internal.BaseComponent {
    constructor() {
        super(...arguments);
        this.rootElRef = preact.createRef();
        this.rowElRefs = new internal.RefMap();
    }
    render() {
        let { props, context } = this;
    ...
    updateCoords() {
        ...
        if (props.onRowCoords && props.clientWidth !== null) { // a populated clientWidth means sizing has stabilized
            this.props.onRowCoords(new internal.PositionCache(this.rootElRef.current, collectRowEls(this.rowElRefs.currentMap, props.rowNodes), false, true));
        }
    }
}
...
class ResourceTimelineGrid extends internal.DateComponent {
    constructor() {
        super(...arguments);
        this.computeHasResourceBusinessHours = internal.memoize(computeHasResourceBusinessHours);
        this.resourceSplitter = new internal$1.ResourceSplitter(); // doesn't let it do businessHours tho
        this.bgSlicer = new internal$2.TimelineLaneSlicer();
    ...
    render() {
        ...
        return (preact.createElement("div", { ref: this.handleEl, className: [
            ...
            preact.createElement(internal.NowTimer, { unit: timerUnit }, (nowDate, todayRange) => (preact.createElement(preact.Fragment, null,
                preact.createElement(internal$2.TimelineSlats, { ref: this.slatsRef, dateProfile: dateProfile, tDateProfile: tDateProfile, nowDate: nowDate, todayRange: todayRange, clientWidth: props.clientWidth, tableColGroupNode: props.tableColGroupNode, tableMinWidth: props.tableMinWidth, onCoords: this.handleSlatCoords, onScrollLeftRequest: props.onScrollLeftRequest }),
                preact.createElement(internal$2.TimelineLaneBg, { businessHourSegs: hasResourceBusinessHours ? null : bgSlicedProps.businessHourSegs, bgEventSegs: bgSlicedProps.bgEventSegs, timelineCoords: slatCoords, 
                ...
                (context.options.nowIndicator && slatCoords && slatCoords.isDateInRange(nowDate)) && (preact.createElement("div", { className: "fc-timeline-now-indicator-container" },
                    preact.createElement(internal.NowIndicatorContainer, { elClasses: ['fc-timeline-now-indicator-line'], elStyle: internal$2.coordToCss(slatCoords.dateToCoord(nowDate), context.isRtl), isAxis: false, date: nowDate }))))))));
    }
    // Hit System
    // ------------------------------------------------------------------------------------------
...
// RENAME?
class ResourceTimelineViewLayout extends internal.BaseComponent {
    constructor() {
        super(...arguments);
        ...
        */
        this.ensureScrollGridResize = () => {
            ...
            }, internal.config.SCROLLGRID_RESIZE_INTERVAL + 1);
        };
    }
    render() {
        let { props, state, context } = this;
        ...
        return (preact.createElement(internal$3.ScrollGrid, { ref: this.scrollGridRef, elRef: this.rootElRef, liquid: !props.isHeightAuto && !props.forPrint, collapsibleWidth: false, colGroups: [
...
class ResourceTimelineView extends internal.BaseComponent {
    constructor(props, context) {
        super(props, context);
        this.processColOptions = internal.memoize(processColOptions);
        this.buildTimelineDateProfile = internal.memoize(internal$2.buildTimelineDateProfile);
        this.hasNesting = internal.memoize(hasNesting);
        this.buildRowNodes = internal.memoize(internal$1.buildRowNodes);
        this.layoutRef = preact.createRef();
        this.rowNodes = [];
        this.renderedRowNodes = [];
        this.buildRowIndex = internal.memoize(buildRowIndex);
        this.handleSlatCoords = (slatCoords) => {
            this.setState({ slatCoords });
        };
        this.handleRowCoords = (rowCoords) => {
    ...
    render() {
        ...
        let slatCols = internal$2.buildSlatCols(tDateProfile, slotMinWidth || this.computeFallbackSlotMinWidth(tDateProfile));
...
ResourceTimelineView.addStateEquality({
    spreadsheetColWidths: internal.isArraysEqual,
});
...
function processColOptions(options) {
    ...
    let allOrderSpecs = options.resourceOrder || internal$1.DEFAULT_RESOURCE_ORDER;
    let plainOrderSpecs = [];
